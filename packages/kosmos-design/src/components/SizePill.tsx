...
export function SizePill({ label, price, selected, disabled, onClick }: SizePillProps) {
  return (
    <button
      ...
      className="h-12 px-[22px] bg-transparent font-sans text-[13px] tracking-[0.06em] uppercase inline-flex gap-[10px] items-center transition-[border-color] duration-200 disabled:cursor-not-allowed disabled:line-through"
    >
